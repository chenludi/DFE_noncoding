#2024/01/16 ChenluDi: Added neugamma distribution (L28-L38)
"""
...
def neugamma(xx, params):
   ...
   # xx is an array of negative gamma values
   xx = np.atleast_1d(xx)
   # gamma(xx, (alpha, beta)) returns the probability for each gamma in the array xx.
