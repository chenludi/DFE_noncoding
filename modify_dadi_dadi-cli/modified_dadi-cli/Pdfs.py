#2024/01/16 ChenluDi: Modified to fit DFE with neugamma distribution.
...
def print_pdf_details(pdf_name):
    ...
    """
    neugamma = """
        neuGamma is a mixture of probability density function.
        pneu proportion with selection coefficient <10^-4 and assume to be neutral.
        params = [alpha, beta, pneu] = [shape, scale, pneu]
    """
    mixture = """
